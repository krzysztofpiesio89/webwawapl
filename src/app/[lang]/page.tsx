...
export default async function Home(props: { params: Promise<{ lang: string  }> }) {
  ...
  return (
    <main className="min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-800 dark:text-white transition-colors">
      ...
      <section className="py-12 bg-slate-100 dark:bg-slate-950 text-center border-t border-slate-200 dark:border-slate-900/60 text-slate-700 dark:text-slate-350 transition-colors duration-300">
        <div className="container mx-auto px-4">
          <p className="text-xs text-slate-800 dark:text-slate-200 mb-2 uppercase font-bold tracking-widest">
            webwawa.pl
          </p>
