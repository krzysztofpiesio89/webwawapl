...
export default async function CityBrandModelPage({ params }: PageProps) {
  ...
  const getUrl = (profKey: 'carRental' | 'leasing' | 'carBuying' | 'mechanic' | 'carParts') => {
    ...
    return `${langPrefix}/${parentPath}/${indSlug}/${profSlug}/${citySlug}/${brandSlug}/${modelSlug}`;
  };

  const transMap = {
    pl: {
      title: "Systemy IT i Marketing dla Biznesu Motoryzacyjnego",
      subtitle: `Dedykowane oprogramowanie, aplikacje PWA oraz pozycjonowanie SEO dla firm powiązanych z marką ${brandName} i modelem ${modelName}.`,
      rentalTitle: "Strony dla Wypożyczalni",
      rentalDesc: `Systemy rezerwacji online i strony WWW dla wypożyczalni aut oferujących samochody ${brandName} ${modelName}.`,
      rentalLink: "Zobacz ofertę dla wynajmu",
      leasingTitle: "Kalkulatory Leasingowe",
      leasingDesc: `Dedykowane formularze wycen, integracje z leasingodawcami i kalkulatory rat dla brokerów samochodów ${brandName} ${modelName}.`,
      leasingLink: "Zobacz systemy finansowe",
      buyingTitle: "Strony dla Skupów Aut",
      buyingDesc: `Landing pages i kampanie marketingowe o wysokiej konwersji, pozyskujące klientów na skup pojazdów ${brandName} ${modelName}.`,
      buyingLink: "Zobacz ofertę dla skupów",
      mechanicTitle: "Oprogramowanie dla Serwisów",
      mechanicDesc: `Aplikacje do rezerwacji terminów i systemy CRM dla warsztatów specjalizujących się w naprawie aut marki ${brandName} ${modelName}.`,
      mechanicLink: "Zobacz systemy dla warsztatów",
      partsTitle: "Sklepy z Częściami",
      partsDesc: `Sklepy e-commerce z wyszukiwarką części po VIN i integracją z bazą zamienników dla modeli ${brandName} ${modelName}.`,
      partsLink: "Zobacz systemy e-commerce"
    },
    en: {
      title: "IT Solutions & Marketing for Automotive Business",
      subtitle: `Custom software, booking applications, and SEO campaigns for businesses related to ${brandName} ${modelName}.`,
      rentalTitle: "Websites for Car Rental",
      rentalDesc: `Online booking systems and responsive sites for car rentals offering ${brandName} ${modelName} vehicles.`,
      rentalLink: "See rental solutions",
      leasingTitle: "Leasing Calculators",
      leasingDesc: `Lease calculators, financing integrations, and quote builders for brokers of ${brandName} ${modelName} cars.`,
      leasingLink: "See financing systems",
      buyingTitle: "Junk Car Buying Landing Pages",
      buyingDesc: `High-converting landing pages and search ad campaigns for businesses buying used or scrap ${brandName} ${modelName} vehicles.`,
      buyingLink: "See buying solutions",
      mechanicTitle: "Software for Auto Repair",
      mechanicDesc: `Online scheduling apps and custom ERP/CRM tools for garages specialized in servicing ${brandName} ${modelName} cars.`,
      mechanicLink: "See repair shop systems",
      partsTitle: "Auto Parts E-commerce",
      partsDesc: `Custom online stores with VIN search engines and catalog integrations for ${brandName} ${modelName} spare parts.`,
      partsLink: "See e-commerce solutions"
    },
    de: {
      title: "IT-Systeme & Marketing für die Automobilbranche",
      subtitle: `Maßgeschneiderte Software, Buchungs-Apps und SEO-Kampagnen für Unternehmen rund um die Marke ${brandName} ${modelName}.`,
      rentalTitle: "Websites für Autovermietung",
      rentalDesc: `Online-Mietwagensysteme und Websites für Autovermietungen mit ${brandName} ${modelName}-Fahrzeugen.`,
      rentalLink: "Mietwagen-Lösungen ansehen",
      leasingTitle: "Leasing-Rechner",
      leasingDesc: `Leasingrechner und Finanzierungsintegrationen für Vermittler von ${brandName} ${modelName}-Fahrzeugen.`,
      leasingLink: "Finanzierungssysteme ansehen",
      buyingTitle: "Webseiten für Autoankauf",
      buyingDesc: `Optimierte Landingpages und Werbekampagnen für Ankäufer von gebrauchten oder defekten ${brandName} ${modelName}-Autos.`,
      buyingLink: "Ankauf-Lösungen ansehen",
      mechanicTitle: "Software für Kfz-Werkstätten",
      mechanicDesc: `Terminplanungs-Apps und CRM-Systeme für Werkstätten mit Spezialisierung auf ${brandName} ${modelName}-Service.`,
      mechanicLink: "Werkstatt-Systeme ansehen",
      partsTitle: "E-Commerce für Autoteile",
      partsDesc: `Online-Shops mit Fahrgestellnummer-Suche und Ersatzteilkatalogen für ${brandName} ${modelName}-Ersatzteile.`,
      partsLink: "E-Commerce-Lösungen ansehen"
    },
    uk: {
      title: "IT-рішення та маркетинг для автобізнесу",
      subtitle: `Спеціалізований софт, системи онлайн-запису та SEO-кампанії для компаній, пов'язаних з маркою ${brandName} та моделлю ${modelName}.`,
      rentalTitle: "Сайти для прокату авто",
      rentalDesc: `Інтерактивні системи бронювання та адаптивні сайти для орендних компаній з автомобілями ${brandName} ${modelName}.`,
      rentalLink: "Дивитись рішення для прокату",
      leasingTitle: "Лізингові калькулятори",
      leasingDesc: `Лізингові форми, кредитні калькулятори та інтеграція фінансування для брокерів автомобілів ${brandName} ${modelName}.`,
      leasingLink: "Дивитись фінансові системи",
      buyingTitle: "Сайти для автовикупу",
      buyingDesc: `Лендінги з високою конверсією та рекламні кампанії в Google для викупу та розбірки машин ${brandName} ${modelName}.`,
      buyingLink: "Дивитись рішення для викупу",
      mechanicTitle: "Софт для автосервісів",
      mechanicDesc: `Додатки для планування візитів та CRM-інструменти для СТО, які спеціалізуються на обслуговуванні ${brandName} ${modelName}.`,
      mechanicLink: "Дивитись системи для СТО",
      partsTitle: "Магазини запчастин",
      partsDesc: `Інтернет-магазини з пошуком деталей за VIN-кодом та інтеграцією каталогів під моделі ${brandName} ${modelName}.`,
      partsLink: "Дивитись e-commerce рішення"
    },
    ru: {
      title: "IT-решения и маркетинг для автобизнеса",
      subtitle: `Специализированный софт, системы онлайн-записи и SEO-кампании для компаний, связанных с маркой ${brandName} и моделью ${modelName}.`,
      rentalTitle: "Сайты для проката авто",
      rentalDesc: `Интерактивные системы бронирования и адаптивные сайты для арендных компаний с автомобилями ${brandName} ${modelName}.`,
      rentalLink: "Смотреть решения для проката",
      leasingTitle: "Лизинговые калькуляторы",
      leasingDesc: `Лизинговые формы, кредитные калькуляторы и интеграция финансирования для брокеров автомобилей ${brandName} ${modelName}.`,
      leasingLink: "Смотреть финансовые системы",
      buyingTitle: "Сайты для автовыкупа",
      buyingDesc: `Лендинги с высокой конверсией и рекламные кампании в Google для выкупа и разборки машин ${brandName} ${modelName}.`,
      buyingLink: "Смотреть решения для выкупа",
      mechanicTitle: "Софт для автосервисов",
      mechanicDesc: `Приложения для планирования визитов и CRM-инструменты для СТО, специализирующихся на обслуживании ${brandName} ${modelName}.`,
      mechanicLink: "Смотреть системы для СТО",
      partsTitle: "Магазины автозапчастей",
      partsDesc: `Интернет-магазины с поиском деталей по VIN-коду и интеграцией каталогов под модели ${brandName} ${modelName}.`,
      partsLink: "Смотреть e-commerce решения"
    },
    zh: {
      title: "汽车出行行业 IT 解决方案与营销",
      subtitle: `针对与 ${brandName} ${modelName} 品牌及车型相关企业的定制化软件、预约排班系统及 SEO 营销方案。`,
      rentalTitle: "汽车租赁租车网站",
      rentalDesc: `支持提供 ${brandName} ${modelName} 车型在线租车预约、车型库展示与自选日期的租车系统网站。`,
      rentalLink: "查看租车方案",
      leasingTitle: "融资租赁月供计算器",
      leasingDesc: `专为 ${brandName} ${modelName} 汽车金融 company 与中介定制的月供计算器及信贷方案表单。`,
      leasingLink: "查看金融计算系统",
      buyingTitle: "二手车收车/报废着陆页",
      buyingDesc: `高转化率 of 收车着陆页与广告投放引流方案，帮助高价收车 company 获得 ${brandName} ${modelName} 车辆线索。`,
      buyingLink: "查看二手车收车方案",
      mechanicTitle: "汽修厂保养与排班软件",
      mechanicDesc: `针对专门维保 ${brandName} ${modelName} 车型的品牌汽修厂开发的在线工位排班与 CRM 会员管理工具。`,
      mechanicLink: "查看汽修厂系统",
      partsTitle: "汽配电商与车架号搜索",
      partsDesc: `具备 VIN 码极速反查、TecDoc 配件目录数据库集成的 ${brandName} ${modelName} 配件商城开发。`,
      partsLink: "查看汽配电商方案"
    }
  };
