...
export default async function AboutUsPage(props: { params: Promise<{ lang: string  }> }) {
  ...
  const address = settings?.address || 'ul. Brzozowa 16, 05-462 Kąck';
  const addressRegistered = settings?.addressRegistered || 'ul. Nadrzeczna 9, 08-400 Górki';
  const nip = settings?.nip || '8262147079';
  const regon = settings?.regon || '381131959';
  const phone = settings?.phone || '+48 664 946 209';

  const homeUrl = params.lang === 'pl' ? '/' : `/${params.lang}`;

  return (
    <main className="min-h-screen bg-slate-50 dark:bg-[#020510] text-slate-800 dark:text-slate-100 transition-colors duration-300">
      {/* Hero Section */}
      <section className="bg-slate-900 dark:bg-slate-950 py-24 text-white relative overflow-hidden border-b dark:border-slate-900/60">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          <nav className="flex justify-center mb-8 text-sm opacity-60 font-semibold">
            ...
            <span className="text-primary">{dict.about.breadcrumb}</span>
          </nav>
          <h1 className="text-4xl md:text-6xl font-black uppercase italic tracking-tight mb-6">
            {dict.about.heroTitle} <span className="gradient-text">webwawa.pl</span>
          </h1>
        ...
        <div className="container mx-auto px-4 max-w-5xl">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-6">
              ...
              <p className="text-slate-600 dark:text-slate-300 font-medium leading-relaxed" dangerouslySetInnerHTML={{ __html: dict.about.storyP1.replace('webwawa.pl', '<strong>webwawa.pl</strong>') }} />
              
              <div className="relative rounded-3xl overflow-hidden shadow-2xl border border-slate-200 dark:border-slate-800/80 aspect-[16/10]">
                <img 
                  src="/images/team_meeting.png" 
                  alt="Zespół webwawa.pl pracujący nad projektem IT" 
                  className="object-cover w-full h-full hover:scale-105 transition-transform duration-500" 
                />
              </div>
              
              <p className="text-slate-600 dark:text-slate-350 font-medium leading-relaxed pt-4">
                {dict.about.storyP2}
              </p>
            </div>
            ...
            <div className="lg:col-span-5 space-y-8">
              <div className="bg-slate-900 dark:bg-slate-950/80 text-white rounded-3xl p-8 shadow-xl relative overflow-hidden border border-slate-800 dark:border-slate-800/50">
                ...
                <div className="space-y-6">
                  <div className="flex items-center gap-4">
                    <div className="text-4xl font-black text-primary dark:text-blue-400">{dict.about.stat1Value}</div>
                    <div>
                  ...
                  <div className="flex items-center gap-4 py-6 border-t border-b border-slate-800 dark:border-slate-800/60">
                    <div className="text-4xl font-black text-primary dark:text-blue-400">{dict.about.stat2Value}</div>
                    <div>
                  ...
                  <div className="flex items-center gap-4">
                    <div className="text-4xl font-black text-primary dark:text-blue-400">{dict.about.stat3Value}</div>
                    <div>
              ...
              <div className="relative rounded-3xl overflow-hidden shadow-2xl border border-slate-200 dark:border-slate-800/80 aspect-[16/10]">
                <img 
                  ...
                  alt="Stanowisko pracy programisty Next.js" 
                  className="object-cover w-full h-full hover:scale-105 transition-transform duration-500" 
                />
              </div>
            </div>
      ...
      <section className="py-20 bg-white dark:bg-slate-950/20 border-t border-b border-slate-200/60 dark:border-slate-900/60 transition-colors duration-300">
        <div className="container mx-auto px-4 max-w-5xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="glass-card hover:-translate-y-2 hover:shadow-xl">
              <div className="text-4xl mb-4">🤝</div>
              <h3 className="font-bold text-xl text-slate-900 dark:text-white mb-3">{dict.about.pillar1Title}</h3>
            ...
            <div className="glass-card hover:-translate-y-2 hover:shadow-xl">
              <div className="text-4xl mb-4">📜</div>
              <h3 className="font-bold text-xl text-slate-900 dark:text-white mb-3">{dict.about.pillar2Title}</h3>
              <p className="text-slate-500 dark:text-slate-400 text-sm font-semibold leading-relaxed">
            ...
            <div className="glass-card hover:-translate-y-2 hover:shadow-xl">
              <div className="text-4xl mb-4">🚚</div>
              <h3 className="font-bold text-xl text-slate-900 dark:text-white mb-3">{dict.about.pillar3Title}</h3>
              <p className="text-slate-500 dark:text-slate-400 text-sm font-semibold leading-relaxed">
      ...
      <section className="py-20 bg-slate-900 dark:bg-slate-950 text-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 max-w-5xl relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="relative rounded-3xl overflow-hidden shadow-2xl border border-slate-800 dark:border-slate-800/80 aspect-[16/10] group">
              <img 
                src="/images/workspace_code.png" 
                alt="Stanowisko robocze programisty" 
            ...
            <div className="relative rounded-3xl overflow-hidden shadow-2xl border border-slate-800 dark:border-slate-800/80 aspect-[16/10] group">
              <img 
                src="/images/team_meeting.png" 
                alt="Spotkanie projektowe zespołu webwawa.pl" 
                className="object-cover w-full h-full group-hover:scale-110 transition-transform duration-700" 
              />
              <div className="absolute inset-0 bg-gradient-to-t from-slate-950 via-slate-950/20 to-transparent opacity-85 group-hover:opacity-90 transition-opacity duration-300 flex flex-col justify-end p-8">
      ...
      <section className="py-20 bg-slate-50 dark:bg-[#030712] border-b border-slate-200/60 dark:border-slate-900/60 transition-colors duration-300">
        <div className="container mx-auto px-4 max-w-5xl">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-5 space-y-6">
              ...
              <div className="glass-card p-6 shadow-sm space-y-4">
                <div className="flex gap-3">
                  ...
                  <div>
                    <h4 className="font-bold text-slate-900 dark:text-white text-sm">{dict.about.locationMainOffice}</h4>
                    <p className="text-slate-500 dark:text-slate-400 text-xs font-semibold mt-1">ul. Księżycowa 76/8, 01-934 Warszawa</p>
                  </div>
                </div>
                <div className="flex gap-3 pt-4 border-t border-slate-200/50 dark:border-slate-800/40">
                  <span className="text-primary text-xl shrink-0">📍</span>
                  <div>
                    <h4 className="font-bold text-slate-900 dark:text-white text-sm">{dict.about.locationRegistry}</h4>
                    <p className="text-slate-500 dark:text-slate-400 text-xs font-semibold mt-1">{addressRegistered}</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-7">
              <div className="relative rounded-3xl overflow-hidden shadow-2xl border border-slate-200 dark:border-slate-800 aspect-[16/10] bg-slate-100 dark:bg-slate-900 min-h-[350px]">
                <iframe
                  ...
                  className="absolute inset-0 w-full h-full dark:invert-[90%] dark:hue-rotate-[180deg]"
                ></iframe>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 max-w-4xl text-center">
          <div className="glass-card p-12 shadow-2xl relative overflow-hidden">
            ...
            <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
              ...
              <Link href={`${homeUrl}#kontakt`} className="btn-secondary text-lg font-black uppercase tracking-wide w-full sm:w-auto text-center">
