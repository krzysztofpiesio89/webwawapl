    ...
    >
      <div className="container mx-auto px-4 flex justify-between items-center relative">
          ...
          <nav className="hidden lg:flex gap-1 xl:gap-2 font-bold items-center">
            ...
            <Button href={`tel:${settings?.phone || '+48664946209'}`} variant="primary" size="sm" className="flex items-center gap-2 ml-2 ring-2 ring-primary/30 hover:ring-primary/60 transition-shadow">
