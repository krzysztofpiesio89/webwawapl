...
const translations = {
  pl: {
    ...
    chartTitle: 'Lighthouse Score — nasze realizacje 99/100',
    yourSite: 'Twoja strona',
    industryAvg: 'Średnia branży',
    typicalWordpress: 'Typowy WordPress',
    metric1: 'zrealizowanych projektów',
    metric2: 'bezpłatna wycena',
    metric3: 'własny kod · zero szablonów',
    metric4: 'ocena klientów',
  ...
  en: {
    ...
    h1c: 'you take them.',
    chartTitle: 'Lighthouse Score — our projects 99/100',
    yourSite: 'Your site',
    industryAvg: 'Industry avg',
    typicalWordpress: 'Typical WordPress',
    metric1: 'completed projects',
    metric2: 'free quote',
    metric3: 'custom code · no templates',
    metric4: 'client rating',
    proof1: 'Next.js · React · Tailwind',
  ...
  uk: {
    ...
    h1c: 'Ви їх забираєте.',
    chartTitle: 'Lighthouse Score — наші роботи 99/100',
    yourSite: 'Ваш сайт',
    industryAvg: 'Середнє по галузі',
    typicalWordpress: 'Типовий WordPress',
    metric1: 'реалізованих проєктів',
    metric2: 'безкоштовна оцінка',
    metric3: 'власний код · без шаблонів',
    metric4: 'оцінка клієнтів',
    proof1: 'Next.js · React · Tailwind',
    proof2: 'Власний код, без конструкторів',
  ...
  ru: {
    ...
    h1c: 'Вы их забираете.',
    chartTitle: 'Lighthouse Score — наши работы 99/100',
    yourSite: 'Ваш сайт',
    industryAvg: 'Среднее по отрасли',
    typicalWordpress: 'Типичный WordPress',
    metric1: 'реализованных проектов',
    metric2: 'бесплатная оценка',
    metric3: 'собственный код · без шаблонов',
    metric4: 'оценка клиентов',
    proof1: 'Next.js · React · Tailwind',
    proof2: 'Собственный код, без конструкторов',
    proof3: 'Варшава и вся Польша',
  ...
  de: {
    ...
    chartTitle: 'Lighthouse Score — unsere Projekte 99/100',
    yourSite: 'Ihre Website',
    industryAvg: 'Branchen-Durchschnitt',
    typicalWordpress: 'Typisches WordPress',
    metric1: 'abgeschlossene Projekte',
    metric2: 'kostenloses Angebot',
    metric3: 'eigener Code · keine Templates',
    metric4: 'Kundenbewertung',
    proof1: 'Next.js · React · Tailwind',
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-6 space-y-8 text-left">
            ...
            <div className="rounded-none border-l-4 border-l-[#818cf8] border-y border-r border-slate-200 dark:border-slate-800 bg-white dark:bg-white/[0.02] p-6 space-y-4 shadow-sm dark:shadow-none">
              ...
              <LighthouseBar label={t.typicalWordpress} score={38} color="#f87171" animate={visible} />
            </div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
              ...
              {/* 4. Trust — client rating */}
              <div className="rounded-none border-t-2 border-amber-500 bg-amber-50 dark:bg-amber-500/10 p-4 shadow-sm dark:shadow-none">
                <p className="text-2xl font-black text-amber-700 dark:text-amber-400 leading-none">5.0<span className="text-base">★</span></p>
                <p className="text-[10px] text-amber-800 dark:text-amber-400/80 uppercase tracking-wider mt-1.5 font-bold">
                  {t.metric4}
                </p>
              </div>
            </div>
